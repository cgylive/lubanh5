...
import lbpEmail from 'core/plugins/lbp-email'
import LbpButton from 'core/plugins/lbp-button'
import LbpPicture from 'core/plugins/lbp-picture'
import LbpSignPicture from 'core/plugins/lbp-sign-picture'
...
export const pluginsList = [
  ...
  },
  {
    ...
    icon: 'photo',
    component: lbpImageJudge,
    visible: true,
    name: lbpImageJudge.name
  },
  {
    title: '标记图片',
    i18nTitle: {
    ...
    icon: 'photo',
    component: LbpSignPicture,
    visible: true,
    name: LbpSignPicture.name
  },
  {
    i18nTitle: {
      'en-US': 'Text',
  ...
  },
  {
    ...
    component: lbpSubject,
    visible: true,
    name: lbpSubject.name
  },
  {
    i18nTitle: {
      'en-US': 'Form Input',
